...
import com.carlosalbertoxw.ollin.finanzas.data.excel.Celda
...
import com.carlosalbertoxw.ollin.finanzas.data.excel.Hoja
import com.carlosalbertoxw.ollin.finanzas.data.excel.HojaExportable
import com.carlosalbertoxw.ollin.finanzas.data.excel.ImportadorExcel
...
import com.carlosalbertoxw.ollin.finanzas.data.excel.XlsxEscritor
...
/**
 * El lector de xlsx, que es el lado que decide cosas por ti: corrige tipos,
 * empareja transferencias, inventa cuentas y recalcula contrapartes. Cada una
 * de esas decisiones se toma sobre datos que el usuario ya no revisa, y por eso
 * se prueba con mas cuidado que el escritor.
 */
