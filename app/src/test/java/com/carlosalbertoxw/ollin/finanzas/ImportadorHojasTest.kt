 ...
 *
 * El libro sale completo de la app, asi que tiene que volver completo: si solo
 * regresara la hoja de movimientos, el catalogo de cuentas, las metas del mes y
 * los pagos por venir se quedarian en el archivo. Aqui se prueba ese regreso.
 */
